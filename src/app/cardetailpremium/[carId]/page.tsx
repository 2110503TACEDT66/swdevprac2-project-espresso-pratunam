          ...
          <div className="w-full">
            ...
            <div className="text-lg font-medium mt-10 mb-10  flex items-center justify-center w-full ">
              <div className="flex flex-row w-[100%] h-[100%]">
                <div className=" bg-gray-100  hover:bg-yellow-500 hover:text-white  p-5 shadow-lg text-center m-1 rounded-lg w-[34%] mb-1 hover:shadow-[0_0_20px_3px_rgba(0,0,255,0.1)]">
                  Zero to hundred{" "}
                ...
                <div className="bg-gray-100  hover:bg-yellow-500 hover:text-white  p-5 shadow-lg text-center m-1 rounded-lg w-[33%] mb-1 hover:shadow-[0_0_20px_3px_rgba(0,0,255,0.1)]">
